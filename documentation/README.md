...
| **01** | [Stack Technique](01-stack.md) | Détail des technologies utilisées (Next.js 16, React 19, Tailwind CSS v4, TypeScript, Zod, Shiki). |
| **02** | [Architecture & Découpage](02-architecture.md) | Structure de dossiers du projet, routage dynamique asynchrone et frontières Client/Server Components. |
| **03** | [Conventions & Design System](03-conventions.md) | Normes de typage strict, gestion native du thème sombre/clair sans flash et gestion de la dette technique via les "Simplifications". |
| **04** | [Intégration API & Sécurisation](04-api-integration.md) | Connexion réseau au backend Laravel 13, validation défensive avec Zod et mise en cache (ISR). |
